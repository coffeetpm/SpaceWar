...
func _spawn_core_flash(pos: Vector2, scale_factor: float) -> void:
	...
	flash.material = load("res://resources/materials/additive_material.tres") as Material
...
func _spawn_energy_spikes(pos: Vector2, scale_factor: float) -> void:
	...
	for i in SPIKE_COUNT:
		...
		var tween_fade := line.create_tween()
		tween_fade.tween_interval(SPIKE_DURATION * 0.3)
		tween_fade.tween_property(line, "default_color:a", 0.0, SPIKE_DURATION)
		tween_fade.tween_callback(func() -> void: line.queue_free())
